    ...
    <section className="py-16 md:py-24">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          ...
          >
            <Link href="/collections/casual-pants" className="block">
              <div className="p-8 md:p-12">
                ...
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-muted-foreground">Comfort flex. Elevate everyday life.</p>
                  </div>
              ...
              <div className="p-8 md:p-12">
                ...
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-neutral-400">Quality denim fabrics in unique fades.</p>
                  </div>
