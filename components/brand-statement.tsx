      ...
      <div className="container max-w-5xl mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold tracking-tight">
            Reinventing classics for the modern man.
          </h2>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Luxurious Fabrics. Expert Craftsmanship. Made To Measure.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Button variant="link" className="text-black underline-offset-8 decoration-2 hover:underline">
              TALK TO A STYLIST
            </Button>
          </div>
        </motion.div>
